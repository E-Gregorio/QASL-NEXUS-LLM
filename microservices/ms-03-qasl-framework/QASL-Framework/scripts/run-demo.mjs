...
/**
 * ═══════════════════════════════════════════════════════════════════════════
 * RUN DEMO - Setup Completo para Demos y Presentaciones
 * ═══════════════════════════════════════════════════════════════════════════
 *
 * Ejecuta TODO el flujo de testing de forma automática:
 *   1. Verifica/Inicia Docker
 *   2. Espera que los servicios estén listos
 *   3. Crea bases de datos de métricas
 *   4. Ejecuta Unit Tests
 *   5. Ejecuta E2E Tests + Envía métricas
 *   6. Ejecuta API Tests + Envía métricas
 *   7. Ejecuta K6 Performance Tests
 *   8. Ejecuta ZAP Security Tests + Envía métricas
 *   9. Abre los dashboards de Grafana
 *
 * Uso:
 *   npm run demo                    # Ejecuta todo
 *   npm run demo -- --skip-zap      # Sin security (más rápido)
 *   npm run demo -- --skip-k6       # Sin performance
 *   npm run demo -- --quick         # Solo E2E + API (demo rápida)
 *
 * ═══════════════════════════════════════════════════════════════════════════
 */
...
║   ╚══▀▀═╝ ╚═╝  ╚═╝╚══════╝╚══════╝    ╚═╝     ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝ ║
║                                                                           ║
║                    DEMO AUTOMATIZADA - QASL FRAMEWORK                     ║
...
exec('start http://localhost:3001/d/sigma-qa-control/sigma-qa-centro-de-control');
...
console.log('║     Centro de Control: http://localhost:3001/d/sigma-qa-control           ║');
